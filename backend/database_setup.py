...
class User(Base):
    ...
    rag_top_k = Column(Integer, default=5, nullable=False)
    max_rag_len = Column(Integer, default=80000, nullable=False)
    rag_n_hops = Column(Integer, default=5, nullable=False)
    rag_min_sim_percent = Column(Float, default=0, nullable=False)
