...
def _bootstrap_global_settings(connection):
    ...
    all_possible_settings = {
        ...
        "default_auto_title": { "value": True, "type": "boolean", "description": "Enable automatic discussion title generation for new users by default.", "category": "Defaults" },
        ...
        "openai_models_mode": { "value": "profiles_only", "type": "string", "description": "Model listing format for OpenAI v1 API: 'profiles_only' (serves only configured model profiles using actual profile names as ID, default) or 'all_models' (forwards all available models in binding/model format).", "category": "Services" },
        "llm_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for LLM models: 'profiles_only' (serves clean profile names as ID, default) or 'all_models' (forwards in binding/model format).", "category": "Services" },
        "tti_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTI models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "tts_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTS models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "stt_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for STT models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "ttv_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTV models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "ttm_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTM models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "rag_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for RAG models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "llm_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for LLM models: 'profiles_only' (serves clean profile names as ID, default) or 'all_models' (forwards in binding/model format).", "category": "Services" },
        "tti_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTI models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "tts_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for TTS models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        "stt_models_advertisement_mode": { "value": "profiles_only", "type": "string", "description": "Advertisement mode for STT models: 'profiles_only' (default) or 'all_models'.", "category": "Services" },
        ...
        "ai_bot_telegram_enabled": { "value": False, "type": "boolean", "description": "Enable Telegram Bot integration for AI Bot.", "category": "AI Bot" },
        "ai_bot_telegram_token": { "value": "", "type": "string", "description": "Telegram Bot token.", "category": "AI Bot" },
        "ai_bot_discord_enabled": { "value": False, "type": "boolean", "description": "Enable Discord Bot integration for AI Bot.", "category": "AI Bot" },
        "ai_bot_discord_token": { "value": "", "type": "string", "description": "Discord Bot token.", "category": "AI Bot" },
        "ai_bot_slack_enabled": { "value": False, "type": "boolean", "description": "Enable Slack Bot integration for AI Bot.", "category": "AI Bot" },
        "ai_bot_slack_app_token": { "value": "", "type": "string", "description": "Slack App Token.", "category": "AI Bot" },
        "ai_bot_slack_bot_token": { "value": "", "type": "string", "description": "Slack Bot User OAuth Token.", "category": "AI Bot" },
        "ai_bot_whatsapp_enabled": { "value": False, "type": "boolean", "description": "Enable WhatsApp Cloud API integration for AI Bot.", "category": "AI Bot" },
        "ai_bot_whatsapp_token": { "value": "", "type": "string", "description": "WhatsApp Cloud API Permanent Access Token.", "category": "AI Bot" },
        "ai_bot_whatsapp_phone_number_id": { "value": "", "type": "string", "description": "WhatsApp Phone Number ID.", "category": "AI Bot" },
