const r=`<template>\r
    <svg xmlns:dc="http://purl.org/dc/elements/1.1/"\r
        ...
        width="128" height="128" version="1.1">\r
        <title>LaTeX Icon</title>\r
        <desc>This is shape (source) for Clarity vector icon theme for gtk</desc>\r
        <metadata>\r
            <rdf:RDF>\r
                <cc:Work rdf:about="">\r
                    <dc:title>LaTeX Icon</dc:title>\r
                    <dc:description>This is shape (source) for Clarity vector icon theme for gtk</dc:description>\r
                    <dc:creator>\r
                        <cc:Agent>\r
                            <dc:title>Jakub Jankiewicz</dc:title>\r
                        </cc:Agent>\r
                    </dc:creator>\r
                    <dc:rights>\r
                        <cc:Agent>\r
