...
function toggleOptionsMenu() {
  ...
  console.log(isOptionsMenuOpen.value)
...
<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 flex space-x-4">
    <!-- Avatar Column -->
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex justify-between items-center">
        ...
        <div v-if="isAuthor" class="relative">
          ...
          <div v-if="isOptionsMenuOpen" 
               class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-md shadow-lg z-10 border dark:border-gray-700">
            <div class="py-1">
              <button @click="handleEdit" class="w-full text-left flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
              ...
              <button @click="handleDelete" class="w-full text-left flex items-center px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-800">
      ...
      <!-- Media Section (e.g., for images or link previews) -->
      <div v-if="post.media && post.media.length > 0" class="mt-3">
