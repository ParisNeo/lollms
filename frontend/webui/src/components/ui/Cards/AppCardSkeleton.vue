<template>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 animate-pulse">
        <div class="flex items-start gap-4 mb-3">
            <div class="h-16 w-16 rounded-md shrink-0 bg-gray-300 dark:bg-gray-700"></div>
            <div class="grow min-w-0 mt-1">
                <div class="h-5 w-3/4 rounded bg-gray-300 dark:bg-gray-600"></div>
                <div class="h-4 w-1/2 rounded bg-gray-200 dark:bg-gray-700 mt-2"></div>
            </div>
        </div>
        ...
        <div class="mt-5">
            ...
            <div class="h-10 w-full rounded-md bg-gray-300 dark:bg-gray-600"></div>
        </div>
    </div>
</template>