...
const props = computed(() => uiStore.modalData('flowResults'));
...
function handleClose() {
    uiStore.closeModal('flowResults');
}
</script>

<template>
    <GenericModal modalName="flowResults" :title="title" maxWidthClass="max-w-6xl">
        <template #body>
