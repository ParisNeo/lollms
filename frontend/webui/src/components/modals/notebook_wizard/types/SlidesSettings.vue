...
function getSuggestedPrompt() {
    ...
    if (props.data.slide_format === 'HTML_Graph') final += " Include data visualizations where appropriate.";
    ...
    <div class="h-full flex flex-col">
        ...
        <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-gray-800 p-6 rounded-xl border dark:border-gray-700">
            ...
            <div>
                ...
                <input v-if="data.style_preset === 'Custom'" v-model="data.custom_style" class="input-field w-full mt-2" placeholder="Describe style (e.g. '8-bit pixel art')" />
            </div>
