...
import JsonRenderer from '../ui/JsonRenderer.vue'; // Updated to use JsonRenderer
                        ...
                        <div v-else class="flex flex-col h-full">
                            ...
                            <div class="flex-grow min-h-0 flex flex-col p-4 space-y-4 overflow-y-auto">
                                ...
                                <div class="space-y-3 text-sm flex-shrink-0">
                                    ...
                                    <!-- Use JsonRenderer for results -->
                                    <div v-if="selectedTask.result" class="mt-2">
                                        <h4 class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-1">Result Data</h4>
                                        <JsonRenderer :json="selectedTask.result" />
                                    </div>
                                </div>
