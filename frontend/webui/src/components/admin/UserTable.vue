                        ...
                        <tr v-for="user in filteredAndSortedUsers" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <button @click="toggleUserStatus(user)" :title="user.is_active ? 'Deactivate User' : 'Activate User'" class="text-gray-400" :class="user.is_active ? 'hover:text-yellow-600 dark:hover:text-yellow-400' : 'hover:text-green-600 dark:hover:text-green-400'">
                                    ...
                                    <button @click="deleteUser(user)" title="Delete User" class="text-gray-400 hover:text-red-600 dark:hover:text-red-400">
