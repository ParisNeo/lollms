<!-- [UPDATE] frontend/webui/src/components/admin/bindings/RAGBindingsSettings.vue -->
<script setup>
            ...
            <div v-else class="space-y-4">
                <div v-for="binding in ragBindings" :key="binding.id" class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col gap-4">
                    <div class="flex items-start gap-4">
                        <span class="mt-1 h-3 w-3 rounded-full flex-shrink-0" :class="binding.is_active ? 'bg-green-500' : 'bg-gray-400'"></span>
                        <div class="flex-grow">
