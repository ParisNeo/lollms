    ...
    <div class="space-y-8">
        ...
        <div v-else>
            <div class="flex justify-between items-center mb-4 flex-wrap gap-4">
                <h2 class="text-2xl font-bold">STT Bindings</h2>
                <div class="flex items-center gap-4">
                    <div>
                        <label for="stt-model-display-mode" class="block text-xs font-medium text-gray-500 dark:text-gray-400">Model Display Mode</label>
                        <select id="stt-model-display-mode" :value="localSttModelDisplayMode" @change="handleDisplayModeChange" class="input-field mt-1">
                    ...
                    <button @click="showAddForm" class="btn btn-primary self-end" v-if="!isFormVisible">+ Add New STT Binding</button>
                </div>
            </div>
