...
<template>
  <div class="relative" v-if="user" v-on-click-outside="closeMenu">
    ...
    >
      <!-- Main Menu Items -->
      <div class="px-1">
        <router-link to="/profile/me" @click="isUserMenuOpen = false" class="w-full text-left flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">My Profile</router-link>
        <router-link to="/settings" @click="isUserMenuOpen = false" class="w-full text-left flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
