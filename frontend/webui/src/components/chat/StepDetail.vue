...
.value-string { color: #2d3748; }
.value-number { color: #dd6b20; font-family: 'Fira Code', monospace; }
.value-boolean { color: #b7791f; font-weight: bold; }
.value-null { color: #718096; font-style: italic; }
.image-field { background-color: rgba(0,0,0,0.03); padding: 0.5rem; border-radius: 6px; max-width: fit-content; }
.embedded-image { display: block; max-width: 100%; max-height: 250px; border-radius: 4px; }
.collapsible-wrapper { border-left: 2px solid rgba(0,0,0,0.1); padding-left: 0.75rem; }
.step-ui-container > div[class^="value-"], .step-ui-container > .image-field { padding: 0.25rem 0.5rem; }
.ui-value > .step-ui-container.is-root { background: none; border: none; padding: 0; }
.collapsible-header { display: flex; align-items: center; gap: 0.25rem; cursor: pointer; padding: 0.25rem 0.5rem; border-radius: 4px; transition: background-color 0.2s; margin-left: -0.75rem; }
.collapsible-header:hover { background-color: rgba(0,0,0,0.05); }
.toggle-icon { transition: transform 0.2s ease-in-out; color: #718096; }
.toggle-icon.is-open { transform: rotate(90deg); }
.summary-text { font-style: italic; font-size: 0.8rem; color: #718096; }
.collapsible-content { padding-top: 0.5rem; }

/* Dark mode */
.dark .step-ui-container.is-root { background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); }
...
.dark .ui-entry { border-bottom: 1px solid rgba(255,255,255,0.1); }
.dark .ui-key { color: #a0aec0; }
.dark .value-string { color: #e2e8f0; }
.dark .value-number { color: #f6ad55; }
.dark .value-boolean { color: #d69e2e; }
.dark .error-entry .ui-key, .dark .error-entry .ui-value { color: #f56565 !important; }
.dark .image-field { background-color: rgba(255,255,255,0.05); }
.dark .collapsible-wrapper { border-left-color: rgba(255,255,255,0.1); }
.dark .collapsible-header:hover { background-color: rgba(255,255,255,0.1); }
</style>